...
//       const response = await axios.get(`https://expertgo-v1.onrender.com/ask/questions/${id}`);
...
//         ? `https://expertgo-v1.onrender.com/ask/expert-answered/${id}`
//         : `https://expertgo-v1.onrender.com/ask/user-answered/${id}`;
...
//     try {
//       const response = await axios.post('https://expertgo-v1.onrender.com/ask/ask', {
//         question,
//         userId
//       });
...
//       await axios.post(`https://expertgo-v1.onrender.com/ask/answer/${id}`, {
//         answer: answerText,
//       });
